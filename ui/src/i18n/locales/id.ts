...
export const id: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Lebar CSS opsional untuk transkrip yang terpusat, seperti 960px, 82%, atau min(1280px, 82%).",
      messageWidthInvalid:
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Peramban lama ini tetap tersedia untuk sementara. Buka kembali melalui HTTPS atau localhost untuk mengamankannya dengan identitas perangkat.",
      pendingUnavailable: "Permintaan pemasangan peramban belum tersedia. Coba lagi sebentar.",
      loadFailed: "Tidak dapat memuat permintaan pemasangan peramban ini: {error}",
