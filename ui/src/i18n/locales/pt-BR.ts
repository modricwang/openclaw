...
export const pt_BR: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthInvalid:
        "Informe uma largura CSS como 960px, 82%, min(1280px, 82%) ou calc(100% - 2rem).",
    },
    sidebarPrefs: {
      title: "Barra lateral",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Apenas o proprietário do tópico e os membros podem agir neste tópico.",
    },
    sessionSuggestions: {
      suggest: "Sugerir",
