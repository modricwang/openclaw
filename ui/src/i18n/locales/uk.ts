...
export const uk: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      action: "Убезпечити цей браузер",
      secureContextRequired:
        "Цей застарілий браузер тимчасово доступний. Відкрийте його через HTTPS або localhost, щоб убезпечити ідентичністю пристрою.",
      pendingUnavailable: "Запит на сполучення браузера ще недоступний. Спробуйте за мить.",
      loadFailed: "Не вдалося завантажити запит на сполучення цього браузера: {error}",
      approvalFailed: "Не вдалося убезпечити цей браузер: {error}",
    },
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Гілку в розмові змінено — перегляньте та надішліть повторно.",
    },
    waitingForApproval: "Очікування схвалення…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Діяти в цій розмові можуть лише її власник і учасники.",
    },
    sessionSuggestions: {
      suggest: "Запропонувати",
