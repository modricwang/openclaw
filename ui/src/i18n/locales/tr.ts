...
export const tr: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Gizli",
    incognitoDescription: "Bu konuşmayı yalnızca Gateway yeniden başlayana kadar sakla",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Bu eski tarayıcı geçici olarak kullanılabilir durumda. Cihaz kimliğiyle güvene almak için HTTPS veya localhost üzerinden yeniden açın.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Konu dalları değiştirdi — gözden geçirin ve yeniden gönderin.",
    },
    waitingForApproval: "Onay bekleniyor…",
    startupStatus: {
    ...
    sessionSuggestions: {
      ...
      sendNow: "{author} kişisinin önerisini şimdi gönder",
      queue: "{author} kişisinin önerisini sıraya al",
      edit: "{author} kişisinin önerisini düzenle",
      dismiss: "{author} kişisinin önerisini yoksay",
      typing: "{name} yazıyor…",
