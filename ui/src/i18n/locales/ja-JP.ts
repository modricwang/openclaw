...
export const ja_JP: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "シークレット",
    incognitoDescription: "このスレッドをGatewayが再起動するまでのみ保持します",
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidth: "メッセージ幅",
      messageWidthHint:
        "中央揃えのトランスクリプトに使用する任意のCSS幅（例: 960px、82%、min(1280px, 82%)）。",
      messageWidthInvalid:
  ...
  profilePage: {
    ...
    identity: {
      title: "アイデンティティ",
      menuLabel: "IDメニュー",
      menuButtonLabel: "{name}のIDおよびアプリメニュー",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "このブラウザは、更新後に一度だけデバイスの承認が必要です。",
      action: "このブラウザを保護",
      secureContextRequired:
        "このレガシーブラウザは一時的に利用可能です。HTTPSまたはlocalhostで再度開き、デバイスIDで保護してください。",
      pendingUnavailable:
  ...
  chat: {
    ...
    composer: {
      ...
      offlineQueuedHint:
        "オフライン — {count} 件をキューに追加。接続が回復するとメッセージが送信されます。",
