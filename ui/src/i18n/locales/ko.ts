...
export const ko: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "이 브라우저는 업데이트 후 일회성 기기 승인이 여전히 필요합니다.",
      action: "이 브라우저 보안 설정",
      secureContextRequired:
        "이 레거시 브라우저는 임시로 사용할 수 있습니다. HTTPS 또는 localhost로 다시 열어 기기 ID로 보안을 설정하세요.",
      pendingUnavailable:
        "브라우저 페어링 요청을 아직 사용할 수 없습니다. 잠시 후 다시 시도하세요.",
      loadFailed: "이 브라우저의 페어링 요청을 불러오지 못했습니다: {error}",
      approvalFailed: "이 브라우저를 보안 설정하지 못했습니다: {error}",
    },
