...
export const vi: TranslationMap = {
  ...
  sessionsView: {
    ...
    archivedBy: "Đã lưu trữ bởi {name}",
    people: "Mọi người",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Trình duyệt cũ này vẫn tạm thời khả dụng. Hãy mở lại qua HTTPS hoặc localhost để bảo mật bằng danh tính thiết bị.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Luồng đã chuyển nhánh — xem lại và gửi lại.",
    },
    waitingForApproval: "Đang chờ phê duyệt…",
    startupStatus: {
    ...
    sessionHeader: {
      ...
      copied: "Đã sao chép",
      incognito: "Cuộc trò chuyện ẩn danh",
    ...
    composer: {
      ...
      offlineQueuedHint:
        "Ngoại tuyến — {count} đang chờ; tin nhắn sẽ được gửi khi kết nối trở lại.",
