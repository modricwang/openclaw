...
export const de: TranslationMap = {
  ...
  sessionsView: {
    ...
    queuedMessage: "{count} Nachricht wartet auf Versand",
    queuedMessages: "{count} Nachrichten warten auf Versand",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Der Thread hat den Branch gewechselt – prüfen und erneut senden.",
    },
    ...
    sessionSuggestions: {
      ...
      attachmentsUnsupported: "Entfernen Sie Anhänge, bevor Sie einen Textvorschlag einreichen.",
      sendNow: "Vorschlag von {author} jetzt senden",
      queue: "Vorschlag von {author} in Warteschlange stellen",
