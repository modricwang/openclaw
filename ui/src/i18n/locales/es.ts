...
export const es: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Este navegador heredado sigue disponible temporalmente. Vuelve a abrirlo a través de HTTPS o localhost para protegerlo con la identidad del dispositivo.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "El hilo cambió de rama: revisa y vuelve a enviar.",
    },
    waitingForApproval: "Esperando aprobación…",
    startupStatus: {
    ...
    composer: {
      ...
      offlineQueuedHint:
        "Sin conexión — {count} en cola; los mensajes se enviarán cuando vuelva la conexión.",
