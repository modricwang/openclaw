...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint: "عرض CSS اختیاری برای رونوشت وسط‌چین، مانند 960px، 82% یا min(1280px, 82%).",
      messageWidthInvalid:
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "این مرورگر پس از به‌روزرسانی همچنان به تأیید یک‌باره‌ی دستگاه نیاز دارد.",
      action: "ایمن‌سازی این مرورگر",
      secureContextRequired:
        "این مرورگر قدیمی موقتاً در دسترس می‌ماند. آن را روی HTTPS یا localhost بازگشایی کنید تا با هویت دستگاه ایمن شود.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "این رشته شاخه‌ها را عوض کرد — بررسی و دوباره ارسال کنید.",
    },
    waitingForApproval: "در انتظار تأیید…",
    startupStatus: {
    ...
    sessionSuggestions: {
      ...
      attachmentsUnsupported: "قبل از ارسال پیشنهاد متنی، پیوست‌ها را حذف کنید.",
    ...
    composer: {
      ...
      offlineQueuedHint: "آفلاین — {count} در صف؛ پیام‌ها با بازگشت اتصال ارسال می‌شوند.",
