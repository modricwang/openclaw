...
export const nl: TranslationMap = {
  ...
  newSession: {
    ...
    startAsDraft: "Als concept starten",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Deze browser heeft na de update nog een eenmalige apparaatgoedkeuring nodig.",
      action: "Beveilig deze browser",
      secureContextRequired:
        "Deze verouderde browser blijft tijdelijk beschikbaar. Open deze opnieuw via HTTPS of localhost om hem met apparaatidentiteit te beveiligen.",
      pendingUnavailable:
        "Het browserkoppelingsverzoek is nog niet beschikbaar. Probeer het zo dadelijk opnieuw.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "De thread wisselde van vertakking — controleer en verstuur opnieuw.",
    },
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Alleen de threadeigenaar en leden kunnen in deze thread handelen.",
    },
    sessionSuggestions: {
      suggest: "Voorstellen",
      suggestMessage: "Bericht voorstellen",
      attachmentsUnsupported: "Verwijder bijlagen voordat je een tekstvoorstel indient.",
      sendNow: "Verstuur het voorstel van {author} nu",
      queue: "Voorstel van {author} in wachtrij plaatsen",
      edit: "Voorstel van {author} bewerken",
      dismiss: "Voorstel van {author} afwijzen",
